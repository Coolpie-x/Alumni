...
const Footer = () => {
  ...
  return (
    <section id="contact">
      ...
      <footer className="lg:h-[25vw] w-full flex flex-col lg:flex-row lg:justify-around items-center justify-center lg:border-b-4 border-white relative bg-gradient-to-r from-black to-black text-white lg:py-[6vw] lg:px-[4vw] py-[10vw] px-[5vw]">
